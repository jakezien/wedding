...
const Accomodations = ({ urls }) => (
  ...
  <section id="accomodations">
    ...
    <h2>Accomodations</h2>
    <div class="left">
      <p>We recommend the <a href={urls.hotel} target="_blank" rel="noopener noreferrer">The Beekman Hotel</a> in Manhattan, <a href={urls.map} target="_blank" rel="noopener noreferrer">at the base of the Brooklyn Bridge.</a> The hotel was built in 1881 on the site of the Chapel Street theater, which in 1761 staged America&rsquo;s first performace of Hamlet, and in 1766 was destroyed in riots over the Stamp Act.</p>
