    ...
    return (
      <section id="boathouse">
        ...
        <div>
          ...
          <h3>Getting There</h3>
          <p>You&rsquo;re looking for <ReactGA.OutboundLink eventLabel="parkEntranceMap" to={urls.parkEntranceMap} target="_blank">the entrance</ReactGA.OutboundLink> on the corner of Ocean Avenue and Lincoln Road, on the east side of the park. Park staff in yellow vests will be waiting to direct you. Cars cannot enter the park, and the boathouse is a five-minute walk from the road.</p>
