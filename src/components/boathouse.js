...
const Boathouse = ({urls}) => (
  <section id="boathouse">
    ...
    <div>
      ...
      <h3>Getting There</h3>
      <p>Prospect Park is bigger than Central Park, so please take care to enter the park from the right place. You&rsquo;re looking for <a href={urls.parkEntranceMap} target="_blank" rel="noopener noreferrer">the entrance</a> on the corner of Ocean Avenue and Lincoln Road, on the east side of the park. Please leave extra time to find the location. Cars can't enter the park, and the boathouse is a 5-minute walk from the road.</p>
